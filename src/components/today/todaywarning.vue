<template>
    <el-row class="bg">
        <p class="title">今日警情</p>

        <el-row class="el el-m">
          <el-row class="f-l">
            <div class="module-block"></div>
            <p class="module-title">数据统计</p>
          </el-row>
          <el-row :gutter="10">
            <el-col :span="12">
        ...
        <el-row class="el">
          ...
          <el-row class="tabs">
            <div class="tab-row f-t">
              <router-link tag="div" :to="{name: 'todaySpread'}"><div class="tab f-c" :class="{'tab-active': 0 == active}" @click="onTabClick(0)"><p class="tab-p">警情分布</p></div></router-link>
              <router-link tag="div" :to="{name: 'todayhighArea'}"><div class="tab f-c" :class="{'tab-active': 1 == active}" @click="onTabClick(1)"><p class="tab-p">高发区域</p></div></router-link>
              <router-link tag="div" :to="{name: 'todayhighRoad'}"><div class="tab f-c" :class="{'tab-active': 2 == active}" @click="onTabClick(2)"><p class="tab-p">高发道路</p></div></router-link>
              <router-link tag="div" :to="{name: 'todayhighCrossing'}"><div class="tab f-c" :class="{'tab-active': 3 == active}" @click="onTabClick(3)"><p class="tab-p">高发路口路段</p></div></router-link>
            </div>
          </el-row>
